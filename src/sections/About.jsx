            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                    ...
                    <h2 className="text-4xl md:text-5xl font-serif italic font-normal text-white" >
                        Hi Im, 
                        <span className="text-4xl md:text-5xl font-sans not-italic font-bold glow-text leading-tight text-secondary-foreground"> Al Zahra Ramadhani.</span>
                    </h2>
                    <div className="space-y-4 text-justify text-muted-foreground">
                      ...
                      <p>I’m also exploring Front-end Developer as a junior developer, using React.js to bring designs to life on the web. I actively participate in competitions and enjoy collaborating with others, believing that continuous learning, creativity, and teamwork are key to building impactful digital solutions.</p>
                    </div>
                ...
                <div className="grid gap-6">
                    {highlights.map((item, idx) => (
                        <div key={idx} className="glass p-6 rounded-2xl" style={{animationDelay: `&{(idx + 1) * 100}ms`}}> 
