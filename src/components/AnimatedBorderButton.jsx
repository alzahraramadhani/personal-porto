...
export const AnimatedBorderButton = () => {
    return (
        <a 
            href="https://drive.google.com/uc?export=download&id=1OAGSM1I3ZAZYK4LVfhabhqJ18-YrggK9"
            target="_blank"
        ...
        >
            ...
            <svg
            className="absolute left-0 top-0 w-full h-full pointer-events-none download-cv-path"
            viewBox="0 0 200 60"
